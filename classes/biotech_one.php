...
$_SESSION['statement'] = 'SELECT fullName,programme,year,date_created FROM internship_reports WHERE programme ="Agricultural Biotechnology" AND year="Year 1"';

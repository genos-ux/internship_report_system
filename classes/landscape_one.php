...
$_SESSION['statement'] = 'SELECT fullName,programme,year,date_created FROM internship_reports WHERE programme ="Landscape Design and Management" AND year="Year 1"';
